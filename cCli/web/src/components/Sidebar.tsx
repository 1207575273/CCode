...
import { IconChat, IconChart, IconHistory, IconSettings, IconScroll, IconNetwork, IconSun, IconMoon, IconMonitor } from './icons'
...
const NAV_ITEMS: NavItem[] = [
  ...
  { to: '/agents', icon: IconNetwork, label: 'Agents' },
