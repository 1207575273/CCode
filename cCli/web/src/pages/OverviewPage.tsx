  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-6 gap-3">
        ...
        <Card label="输入 Token" value={fmtTokens(totalInput)} color="text-accent" />
        <Card label="输出 Token" value={fmtTokens(totalOutput)} color="text-success" />
        ...
        <Card label="费用" value={costs.join(' + ') || '-'} color="text-warning" />
      </div>
      ...
      {/* 四维饼图：按供应商分布 */}
      <div className="bg-elevated rounded-lg p-4">
        <h3 className="text-sm text-txt-secondary mb-3">供应商分布（四维 Token）</h3>
      ...
      <div className="bg-elevated rounded-lg p-4">
        ...
        {(() => {
          ...
          if (filtered.length === 0) return <p className="text-txt-muted text-sm">该时间段无会话</p>
          return (
