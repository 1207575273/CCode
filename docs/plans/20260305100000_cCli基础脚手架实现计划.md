...
**Goal:** 从零搭建 ZCli 项目骨架，使 `pnpm dev` 可以启动一个最小化的 CLI 界面，并且测试基础设施就绪。
...
预期: 终端显示 ZCli 标题、ChatView 占位文字、底部 StatusBar，按 Ctrl+C 正常退出

**Step 6: Commit**

```bash
git add bin/zcli.ts src/ui/
